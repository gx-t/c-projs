...
static int str_to_sockaddr_in(const char* str_ip, const char* str_port)
{
...
static int clnt_main(int argc, char* argv[])
{
    ...
    if(ERR_OK != (res = str_to_sockaddr_in(str_srv_ip, str_srv_port)))
        return res;
